...
// Verwacht antwoord:
// Martin Balsam
const lastIndexMovies = movies.length-1;
const lastIndexActors = movies[lastIndexMovies].actors.length-1;
console.log(movies[lastIndexMovies].actors[lastIndexActors]);
...
// maar wel hoger dan een 6.5 en een 'Matige film' logt bij een lager cijfer dan 6.5.
...
if (selectedMovie.rating > 8) {
  console.log(`Topper!`);
} else if (selectedMovie.rating === 8 || (selectedMovie.rating > 6.5 && selectedMovie.rating < 8)) {
  console.log(`Kijktip!`);
} else {
